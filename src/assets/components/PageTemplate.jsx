 ...
 */
export default function PageTemplate({ children, showNav = true, className = '' }) {
  return (
    <LayoutProvider>
      <div className={`page-template min-h-screen flex w-full ${className}`}> 
        ...
        <div className="flex-1 p-6 lg:p-8 bg-background transition-all duration-300"> {/* substitute background if needed */}
          {children}
        </div>
      </div>
    </LayoutProvider>
