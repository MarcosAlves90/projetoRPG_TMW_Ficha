        ...
        <section className={`${styles.sectionCommon} ${isCollapsed ? styles.compact : ''}`}>
            ...
            <fieldset className={styles.inputsFieldset}>
                <div className={styles.styledTextField}>
                    <label>Nome</label>
                    <input type="text" value={userData.nome || ''} onChange={onInputChange('nome')} />
                </div>
                <div className={styles.styledTextField}>
                    <label>Data de Nascimento</label>
                    <input type="text" value={userData.idade || ''} onChange={onInputChange('idade')} />
                </div>
                <div className={styles.styledTextField}>
                    <label>Profissão</label>
                    <input type="text" value={userData.profissao || ''} onChange={onInputChange('profissao')} />
                </div>
            </fieldset>
            <fieldset className={styles.inputsFieldset}>
                    <div className={styles.styledTextField}>
                        <label>Título</label>
                        <input type="text" value={userData.titulo || ''} onChange={onInputChange('titulo')} />
                    </div>
